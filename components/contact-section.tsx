...
export function ContactSection() {
  ...
  async function copyEmail() {
    try {
      await navigator.clipboard.writeText("surajadhikari01@icloud.com");
      setCopyState("Copied!");
    } catch {
      setCopyState("Select the email to copy");
    }
    if (timer.current) clearTimeout(timer.current);
      ...
      <div className="site-shell">
        <div className="contact-heading">
          ...
          <a
            ...
            href="mailto:surajadhikari01@icloud.com"
        ...
        <div className="contact-bottom">
          ...
          <div className="contact-email">
            <a href="mailto:surajadhikari01@icloud.com">
              surajadhikari01@icloud.com
            </a>
            <button onClick={copyEmail} aria-label={copyState}>
              {copyState === "Copied!" ? (
                <Check size={15} />
              ) : (
                <Copy size={15} />
        ...
        <footer className="site-footer">
          ...
          <div>
            ...
            <a
              href="https://www.linkedin.com/in/surajadk/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <a href="#home">
            Back to the beginning <ArrowUp size={14} />
          </a>
        </footer>
      </div>
    </section>
