  ...
  return (
    <section id="contact" className="relative overflow-hidden border-t border-border/60 py-20">
      ...
      <div className="site-shell relative grid items-center gap-10 lg:grid-cols-[1.2fr_.8fr_.6fr]">
        ...
        <div><p className="max-w-xs text-xs leading-6 text-muted-foreground">Available from Nepal for remote software engineering, AI and C++ development opportunities worldwide.</p><a href="mailto:surajadhikari01@icloud.com" className="group mt-5 inline-flex h-12 items-center gap-8 rounded-xl bg-[#121218] px-6 text-xs font-semibold text-white shadow-lg transition-transform hover:-translate-y-0.5">Get in touch<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1"/></a></div>
